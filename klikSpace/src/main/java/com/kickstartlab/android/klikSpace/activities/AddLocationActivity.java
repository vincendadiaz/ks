...
public class AddLocationActivity extends ActionBarActivity {
    ...
    String locationId, locationName , extId, yes, no;
    ...
    public void saveRack(){
        ...
        location.setCityId(locationId);
        location.setCityName(locationName);
        location.setCreatedDate(createdDate);
        ...
        EventBus.getDefault().postSticky(new LocationEvent("refreshById", locationId));
        EventBus.getDefault().post(new LocationEvent("syncRack", location));
