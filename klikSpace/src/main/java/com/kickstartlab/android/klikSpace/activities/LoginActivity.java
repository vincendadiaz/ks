...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor>{
    ...
    private SmoothProgressBar mProgressView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mEmailView = (AutoCompleteTextView) findViewById(R.id.email).getBackground().setColorFilter(Color.WHITE, PorterDuff.Mode.MULTIPLY);
        mEmailView = (MaterialEditText) findViewById(R.id.email);
        //mEmailView.getBackground().setColorFilter(Color.WHITE, PorterDuff.Mode.MULTIPLY);
        //populateAutoComplete();

        mPasswordView = (MaterialEditText) findViewById(R.id.password);
        //mPasswordView.getBackground().setColorFilter(Color.WHITE, PorterDuff.Mode.MULTIPLY);
        ...
        mProgressView = (SmoothProgressBar) findViewById(R.id.login_progress);
    ...
    public void attemptLogin() {
        ...
        if (cancel) {
            ...
            RestAdapter restAdapter = new RestAdapter.Builder()
                    .setEndpoint(getResources().getString(R.string.api_base_url_login))
                    .build();

            AmApiInterface amApiInterface = restAdapter.create(AmApiInterface.class);

            amApiInterface.doLogin(email, password, new Callback<MemberData>() {
                @Override
                public void success(MemberData memberData, Response response) {

                    String result = memberData.getStatus();
                    if( "ERR".equalsIgnoreCase(result)){
                        Toast.makeText(LoginActivity.this, "Invalid User Name or Password", Toast.LENGTH_SHORT).show();
                    }else{
                        SharedPreferences.Editor editor = spref.edit();

                        String authkey = memberData.getSessionKey();
                        String uid = memberData.getMongoid();

                        Log.i("session_key",memberData.getSessionKey());
                        Log.i("MSG",memberData.getMsg());
